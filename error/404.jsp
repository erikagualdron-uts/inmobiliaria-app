...
<html lang="es">
<head>
    <% String hgTitulo = "Página no encontrada"; %>
...
<div class="hg-container" style="min-height:80vh; display:flex; align-items:center; justify-content:center; text-align:center;">
    <div>
        ...
        <h1 style="font-size:2.4rem; margin-bottom:12px;">Esta página no existe</h1>
        <p style="color:var(--hg-ink-muted); max-width:46ch; margin:0 auto 24px;">
            Puede que el enlace esté mal escrito o que la propiedad ya no esté disponible.
        </p>
