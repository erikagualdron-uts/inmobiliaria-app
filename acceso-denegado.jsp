...
<div class="hg-container" style="min-height:80vh; display:flex; align-items:center; justify-content:center; text-align:center;">
    <div>
        ...
        <h1 style="font-size:2.4rem; margin-bottom:12px;">No tienes permiso para ver esta página</h1>
        <p style="color:var(--hg-ink-muted); max-width:46ch; margin:0 auto 24px;">
            ...
            <% } else { %>
                Necesitas iniciar sesión con una cuenta autorizada para ver esta sección.
            <% } %>
        </p>
        <div style="display:flex; gap:12px; justify-content:center; flex-wrap:wrap;">
            <a class="hg-btn hg-btn--primary" href="<%= request.getContextPath() %>/index.jsp">Volver al inicio</a>
            <% if (!haySesion) { %>
            <a class="hg-btn hg-btn--ghost" href="<%= request.getContextPath() %>/login.jsp">Iniciar sesión</a>
            <% } %>
        </div>
    </div>
</div>
